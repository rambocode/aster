...
open class TerminalView: UIScrollView, UITextInputTraits, UIKeyInput, UIScrollViewDelegate, TerminalDelegate, UIPointerInteractionDelegate {
    ...
    /// macOS uses this for smooth/overscroll rendering. UIKit keeps the value at zero and uses
    /// UIScrollView's content offset instead, but the shared renderer needs a common property.
